    ...
    <div>
        ...
        <div className={`top-bar-content${isMinimized ? ' minimized' : ''}`}>
          ...
          <div className={`side-panel${isPanelOpen ? ' open' : ''}`}>
            <div className="buttonslayout-mobile">
              ...
              <button className="About-Us">About</button>
              <button className="Help">Help</button>
              <button className="Privacy">Privacy</button>
              <button className="Back" onClick={togglePanel} >Back</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="layout">
        ...
        <div className="what-we-do">
          <h2>What we do</h2>
          <p>
            At OA Fitness, our mission is to connect clients with the perfect coach who matches their specific interests and
            goals. We understand that finding the right coach can make all the difference in achieving fitness success,
            whether it's in boxing, workouts, MMA, or any other discipline. That's why we've developed a comprehensive
            platform that enables clients to easily locate and connect with qualified coaches in their local area or closest
            proximity.
          </p>

          <p>
            With OA Fitness, the search for a coach that aligns with your interests becomes effortless. Our user-friendly
            interface allows you to browse through a wide range of coaches, each specializing in different fitness areas,
            ensuring that you find the perfect match for your needs. Whether you're a beginner looking to start your fitness
            journey or an experienced athlete aiming to take your skills to the next level, we have the right coach for you.
          </p>
        </div>
